...
// import Loader from '../Loader/Loader';
// // import { getItemStorage, setItemStorage } from '../../actions/localStorage';
// // import { addItem } from '../../actions/cart';

// export default function Item() {
//     const { item, loading, error, size } = useSelector(state => state.item);
//     // const storage = useSelector(state => state.localStorage.cart);
...
//          dispatch(addCartItem(cartArray, cartObject, updateCart));
//         navigate('/cart');
//     };
